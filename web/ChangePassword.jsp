            ...
            <section class="vh-100 mb-4">
                <div class="container py-5 h-100">
                    <div class="row d-flex align-items-center justify-content-center h-100">
                        <div>
                            <a href="home"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-arrow-left-circle-fill" viewBox="0 0 16 16">
                        ...
                        <div class="row col-md-7 col-lg-5 col-xl-5 offset-xl-1">
                            <form name="changepassword" action="changepassword" method="post" onsubmit="required()">
                                <!-- Email input -->
                                ...
                                <div class="form-outline col-xd-4 col-xs-12">
                                    ...
                                    <input name="user_email" type="text" id="form1Example13" class="form-control form-control-lg" />
                                </div>
